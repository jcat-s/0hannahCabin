export function AboutSection() {
  return (
    <section id="about" className="py-20 sm:py-24 bg-white scroll-mt-20 relative overflow-hidden">
      {/* Background Decorative Element */}
      <div className="hidden md:block absolute top-0 right-0 w-1/2 lg:w-1/3 h-full bg-zinc-50 -z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20 space-y-4">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif italic text-zinc-900 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
            Enjoy a Stunning <span className="not-italic">A-Frame Cabin</span>
            <span className="block">in Malvar, Batangas</span>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="relative group order-2 lg:order-1 mx-auto lg:mx-0 max-w-xl">
            {/* The main frame */}
            <div className="relative z-10 bg-white p-3 shadow-2xl border border-zinc-100 rounded-3xl overflow-hidden">
              <div className="overflow-hidden aspect-[4/5] sm:aspect-[3/4] rounded-3xl">
                <img
            ...
            {/* Gold Offset Border */}
            <div className="absolute -bottom-5 -left-5 w-full h-full border border-[#D4AF37] -z-10 group-hover:translate-x-2 group-hover:translate-y-2 transition-transform duration-500 rounded-3xl" />

            {/* Elegant Tag */}
            <div className="hidden md:flex absolute top-10 -right-8 bg-black text-white px-5 py-3 transform rotate-90 origin-left uppercase tracking-[0.3em] text-[10px] font-bold rounded-sm">
              Private Sanctuary
            </div>
          </div>
          ...
          <div className="space-y-8 order-1 lg:order-2">
            ...
            <div className="bg-zinc-50 border-l-4 border-[#D4AF37] p-6 sm:p-8 space-y-6 shadow-sm rounded-3xl">
            ...
            {/* Warning / Notes */}
            <div className="p-4 bg-zinc-100 rounded-3xl flex items-start gap-4">
